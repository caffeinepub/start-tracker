...
export class Backend implements backendInterface {
    ...
    async clickNoStart(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.clickNoStart();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async clickStart(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.clickStart();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCounts(): Promise<[bigint, bigint]> {
        if (this.processError) {
            try {
    ...
    async resetCounts(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetCounts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
